...
MIDDLEWARE = [
    # 'app.middleware.VerifyTokenMiddleware',
...
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
EMAIL_HOST_USER = 'videobase78@gmail.com'  # Twój adres e-mail Gmail, z którego będziesz wysyłać wiadomości
EMAIL_HOST_PASSWORD = 'bgvputyubkodvuwi'  # Hasło do Twojego konta Gmail